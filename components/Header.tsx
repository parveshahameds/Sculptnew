    ...
    return (
        <header className="py-4 lg:py-5 xl:py-6 flex items-center justify-between border-b" style={{ borderColor: 'rgba(44, 44, 44, 0.08)' }}>
            ...
            <div className="flex items-center gap-2 lg:gap-3 xl:gap-4">
                ...
                {/* Credits Display */}
                <div className="flex items-center gap-2 px-3 lg:px-4 py-2 bg-gradient-to-br from-[#F5F1E8] to-[#E5E4E2] border rounded-full shadow-sm"
                     style={{ borderColor: 'rgba(184, 148, 31, 0.2)' }}>
                    <div className="w-7 h-7 lg:w-8 lg:h-8 bg-gradient-to-br from-[#D4AF37] to-[#B8941F] rounded-full flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 lg:h-[18px] lg:w-[18px] text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </div>
                    <div className="flex flex-col">
                        <span className="text-[9px] lg:text-[10px] uppercase tracking-wider leading-none mb-0.5" style={{ color: '#8B8680', fontWeight: 500 }}>
                            Credits
                        </span>
                        <span className="text-[14px] lg:text-[16px] leading-none font-bold" style={{ color: credits !== null && credits < 10 ? '#DC2626' : '#2C2C2C' }}>
